...
//        $data = DB::connection('mysql_service')->table('for_repair')->where([['city', '=', $con_com_data->city_id], ['close', 0], ['confirm', '=', 'confirmed']])->whereIn('fr_type',$fr);
        ...
        $data = DB::connection('mysql_service')->table('for_repair')->where([['city', '=', $con_com_data->city_id], ['confirm', '=', 'confirmed'],['delete','=',0]])->orWhere([['city', '=', $con_com_data->city_id], ['confirm', '=', 'confirmed'],['delete','=',NULL]])->whereIn('fr_type', $fr)->orderBy('id', 'desc');
...
//                    dd($sub_m);
    ...
    public function detail_project_without_request($pid)
    {
        ...
        //ki fixed here
       $user_saw2 = DB::table('see_projects_with_plan')->insert(['user_id' => Auth::user()->id,'project_id' => $pid, 'plan'=>'free' ,'created_at' => Carbon::now(), 'updated_at' => Carbon::now()]);
